...
| **View architecture** | Read [architecture.md](architecture.md) | 15 min |
| **See templates** | Check [architecture.md](architecture.md) Section 2-4 | 10 min |
| **Configure Claude** | Copy [claude-system-prompt.md](claude-system-prompt.md) | 5 min |
| **Understand folders** | See [Where Things Are](#where-things-are) below | 2 min |
| **Get help** | Read [quickstart.md](quickstart.md) (detailed guide) | 30 min |
...
Copy the full system prompt from [claude-system-prompt.md](claude-system-prompt.md) to your Claude Code settings.
...
**Current Phase:** P1 - Standards Implementation (45% complete)
...
**Resources:**
- **Detailed Setup:** [quickstart.md](quickstart.md) - Full 2-hour guide with explanations
- **Architecture:** [architecture.md](architecture.md) - Complete system design
- **Claude Integration:** [claude-system-prompt.md](claude-system-prompt.md) - Full prompt
- **Standards:** Check zsh-configuration standards for ADHD-friendly patterns

**Get Stuck?**
1. Read [quickstart.md](quickstart.md) for detailed explanations
2. Check [architecture.md](architecture.md) for template details
